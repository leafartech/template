  ...
  return (
    <div>
      ...
      <header className="relative h-[500px] flex items-center justify-center">
        ...
        />
        <div className="relative z-50 flex items-center flex-col gap-3 w-full max-w-6xl text-center">
      ...
      <main className="bg-zinc-100">
        <Section className="py-12">
          <div className="text-center mb-6">
            <h2 className="text-3xl font-semibold tracking-wider">Lorem ipsum dolor sit amet</h2>
        ...
        <Section className="py-12">
          ...
          />
          <div className="w-full h-32 grid grid-cols-2 mt-16">
            <div className="w-full h-full bg-white border border-zinc-300 rounded-xl"></div>
            <div className="w-full h-full bg-white border border-zinc-300 border-l-0 rounded-xl"></div>
          </div>
        </Section>
        <Section className="py-12">
          <HeroFlex
        ...
        <Section className="py-12">
          <div className="w-full h-[450px] grid grid-cols-2">
            ...
            <div className="h-full bg-white rounded-xl border border-zinc-300 border-l-0">
      ...
      <footer className="py-12 w-full flex justify-center items-center bg-zinc-700">
